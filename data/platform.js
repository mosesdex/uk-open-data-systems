...
export default {
  ...
  sequence: [
    ['Publish the planning area geography', 'Months 1 to 3', 'Open, unpaid, under an open licence. It is weeks of work, demonstrably missing, and it converts an unknown supplier into the people who fixed something government wanted fixed. The named team that owns the survey is the buyer for everything after.'],
    ['Ship Catchment on top of it', 'Months 3 to 9', 'Small-area demand forecasting and the surplus-shortage adjacency map. The National Audit Office has already written the thesis: national projections are accurate, the failure is spatial.'],
    ['Build the entity spine and Sentinel', 'Months 6 to 15', 'Organisation resolution first, then process indicators and framework concentration. Route findings through the compliance service, which is open to anyone, rather than the review service, which is not.'],
    ['Extend the place spine to Highwater and Plumbline', 'Months 12 to 24', 'Both consume the same asset. Two further buyers in two further departments, at marginal cost.'],
    ['Junction last', 'Months 18 to 30', 'It needs both spines mature, and four of six network operators must first be persuaded to serve data to anonymous clients.']
  ],
