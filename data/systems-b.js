// Systems 06 to 10. Content module consumed by build.js.
export default [

{
  ...
  problem: [
    ...
    'The absolute numbers rose sharply: permissions granted against EA flood advice went <strong>28 in 2021-22 to 102 in 2024-25</strong>. But the honest reading is more interesting than the alarming one. The <strong>rate</strong> stayed roughly flat at 3 to 5% across all nine years, which is consistent with the government line that 96% of decisions follow EA advice. More homes were permitted against advice because more applications were objected to, not because councils became more willing to override. Anyone presenting the 3.6-fold rise without the flat rate will be taken apart in the first meeting, and rightly.',
    'The EA reports "over 97% compliance" with its advice. Aviva, joining Ordnance Survey AddressBase to the national flood risk assessment, found <strong>one in nine new English homes built 2022 to 2024 is in a medium or high flood risk area</strong>, 43,937 homes. Both statements are true. The gap between them exists because the EA counts objections it made, not homes that were built, and because <strong>surface water flooding sits largely outside its objection trigger</strong> despite being the fastest-growing risk.',
  ...
  impact: [
    ...
    ['3 to 5%', 'Rate of permissions against EA flood advice, flat for nine years, while counts tripled'],
    ['1 in 9', 'New English homes built 2022 to 2024 in medium or high flood risk areas'],
...

{
  ...
  features: [
    ...
    ['Substation gazetteer', 'Free-text connection sites resolved to coordinates, making the transmission queue mappable for the first time. Around 45% matches from three open sources today; a realistic ceiling is 70 to 75%, because roughly a fifth of the queue is unbuilt placeholder nodes and privately-owned generator substations that no gazetteer can ever match. Say so plainly, a stakeholder told “we will geocode the queue” hears 100%.'],
